...
_Creare la migration per la tabella technologies

_Creare il model Technology

_Creare la migration per la tabella pivot project_technology

_Aggiungere ai model Technology e Project i metodi per definire la relazione many to many

_Visualizzare nella pagina di dettaglio di un progetto le tecnologie utilizzate, se presenti
permettere all'utente di associare le tecnologie nella pagina di creazione e modifica di un progetto

_Gestire il salvataggio dell'associazione progetto-tecnologie con opportune regole di validazione
